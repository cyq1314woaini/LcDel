...
inpath = "/home/yuyanan/AssemblySv/alginment/pbsv/clr/10x/pbsv.clr.10x.deltion.vcf"
outpath = "/home/yuyanan/AssemblySv/alginment/pbsv/clr/10x/interval"
outpath1 = os.path.join(outpath, "pbsv.clr.69x.del.1-22.50-200.vcf")
outpath2 = os.path.join(outpath, "pbsv.clr.69x.del.1-22.200-500.vcf")
outpath3 = os.path.join(outpath, "pbsv.clr.69x.del.1-22.500-1000.vcf")
outpath4 = os.path.join(outpath, "pbsv.clr.69x.del.1-22.1000-2000.vcf")
outpath5 = os.path.join(outpath, "pbsv.clr.69x.del.1-22.2000+.vcf")
