...
inpath = "/home/yuyanan/AssemblySv/alginment/svim/clr/10x/svim.clr.10x.deletion.s2.vcf"
outpath = "/home/yuyanan/AssemblySv/alginment/svim/clr/10x/interval2"
outpath1 = os.path.join(outpath, "svim.clr.10x.del.1-22.50-200.vcf")
outpath2 = os.path.join(outpath, "svim.clr.10x.del.1-22.200-500.vcf")
outpath3 = os.path.join(outpath, "svim.clr.10x.del.1-22.500-1000.vcf")
outpath4 = os.path.join(outpath, "svim.clr.10x.del.1-22.1000-2000.vcf")
outpath5 = os.path.join(outpath, "svim.clr.10x.del.1-22.2000+.vcf")
